...
const types = [
    ...
    ["/cosmos.staking.v1beta1.MsgEditValidator", tx_2.MsgEditValidator],
...
const txClient = async (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => {
    ...
    return {
        ...
        msgEditValidator: (data) => ({ typeUrl: "/cosmos.staking.v1beta1.MsgEditValidator", value: tx_2.MsgEditValidator.fromPartial(data) }),
        msgUndelegate: (data) => ({ typeUrl: "/cosmos.staking.v1beta1.MsgUndelegate", value: tx_3.MsgUndelegate.fromPartial(data) }),
