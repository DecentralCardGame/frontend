...
const types = [
    ...
    ["/cosmos.gov.v1beta1.MsgVoteWeighted", tx_3.MsgVoteWeighted],
...
const txClient = async (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => {
    ...
    return {
        ...
        msgVote: (data) => ({ typeUrl: "/cosmos.gov.v1beta1.MsgVote", value: tx_1.MsgVote.fromPartial(data) }),
        msgSubmitProposal: (data) => ({ typeUrl: "/cosmos.gov.v1beta1.MsgSubmitProposal", value: tx_2.MsgSubmitProposal.fromPartial(data) }),
        msgVoteWeighted: (data) => ({ typeUrl: "/cosmos.gov.v1beta1.MsgVoteWeighted", value: tx_3.MsgVoteWeighted.fromPartial(data) }),
