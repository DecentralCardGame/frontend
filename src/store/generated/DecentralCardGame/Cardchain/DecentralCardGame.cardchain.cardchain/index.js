...
exports.VotingResults = exports.VotingResult = exports.VoteRight = exports.RunningAverage = exports.QueryQServerResponse = exports.IgnoreSellOffers = exports.IgnoreMatches = exports.Params = exports.Num = exports.MatchReporterProposal = exports.MatchPlayer = exports.Image = exports.WrapHashResponse = exports.WrapClearResponse = exports.CopyrightProposal = exports.CollectionProposal = exports.Card = void 0;
const module_1 = require("./module");
const card_1 = require("./module/types/cardchain/card");
Object.defineProperty(exports, "Card", { enumerable: true, get: function () { return card_1.Card; } });
const collection_proposal_1 = require("./module/types/cardchain/collection_proposal");
...
const copyright_proposal_1 = require("./module/types/cardchain/copyright_proposal");
...
const getDefaultState = () => {
    return {
        ...
        QServer: {},
        _Structure: {
            Card: getStructure(card_1.Card.fromPartial({})),
            CollectionProposal: getStructure(collection_proposal_1.CollectionProposal.fromPartial({})),
            CopyrightProposal: getStructure(copyright_proposal_1.CopyrightProposal.fromPartial({})),
            WrapClearResponse: getStructure(council_1.WrapClearResponse.fromPartial({})),
            WrapHashResponse: getStructure(council_2.WrapHashResponse.fromPartial({})),
            Image: getStructure(image_1.Image.fromPartial({})),
            MatchPlayer: getStructure(match_1.MatchPlayer.fromPartial({})),
            MatchReporterProposal: getStructure(match_reporter_proposal_1.MatchReporterProposal.fromPartial({})),
            Num: getStructure(num_1.Num.fromPartial({})),
            Params: getStructure(params_1.Params.fromPartial({})),
            IgnoreMatches: getStructure(query_1.IgnoreMatches.fromPartial({})),
            IgnoreSellOffers: getStructure(query_2.IgnoreSellOffers.fromPartial({})),
            QueryQServerResponse: getStructure(query_3.QueryQServerResponse.fromPartial({})),
            RunningAverage: getStructure(running_average_1.RunningAverage.fromPartial({})),
            VoteRight: getStructure(vote_right_1.VoteRight.fromPartial({})),
            VotingResult: getStructure(voting_result_1.VotingResult.fromPartial({})),
            VotingResults: getStructure(voting_results_1.VotingResults.fromPartial({})),
        },
    ...
    actions: {
        ...
        async QueryQCards({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params, query = null }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryQCards(key.status, { ...query, 'pagination.key': value.pagination.next_key })).data;
        ...
        async QueryQMatches({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params, query = null }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryQMatches({ ...query, 'pagination.key': value.pagination.next_key })).data;
                    value = mergeResults(value, next_values);
                }
        ...
        async QueryQSellOffers({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params, query = null }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryQSellOffers(key.status, { ...query, 'pagination.key': value.pagination.next_key })).data;
                    value = mergeResults(value, next_values);
                }
        ...
        async QueryQServer({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params, query = null }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryQServer', payload: { options: { all }, params: { ...key }, query } });
