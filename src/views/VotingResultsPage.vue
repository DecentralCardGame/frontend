<template>
  <div class="gallery">
    ...
    <p class="header__p">
      ...
      Total <b>Fair Enough</b> Votes: {{ state.data.totalFairEnoughVotes }}
      <br />
      Total <b>Inappropriate</b> Votes: {{ state.data.totalInappropriateVotes }}
      <br />
      Total <b>Overpowered</b> Votes: {{ state.data.totalOverpoweredVotes }}
      <br />
...
import { VotingResults } from "decentralcardgame-cardchain-client-ts/lib/types/cardchain/cardchain/voting_results";
...
const { queryVotingResults } = useQuery();
