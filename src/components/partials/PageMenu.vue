    ...
    <nav class="nav">
      <div class="nav__content">
        ...
        <ul :class="showMenuClass">
          ...
          <li>
            <router-link to="/cardCreator"> Card Creator </router-link>
          </li>
          <li>
          ...
          <li>
            <router-link v-if="loggedIn" to="/user/me"> Account </router-link>
          </li>
        </ul>
      </div>
    </nav>
...
.nav {
  ...
  box-shadow: $border-thickness-bold * 1.5 $border-thickness-bold * 1.5 0
    $minor-color-c;
  position: relative;
  margin: 2.5rem 5rem;
...
.nav__authentication-modal {
  ...
  margin-top: -2.5rem;
  z-index: 10000000;
  box-shadow: $border-thickness-bold * 1.5 $border-thickness-bold * 1.5
    rgba(0, 0, 0, 0.3);
  @media (max-width: 1178px) {
    width: 100vw;
    margin-top: -1px;
