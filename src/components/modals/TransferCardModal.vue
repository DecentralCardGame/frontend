<template>
  <div>
    <p class="font-bold text-2xl">Transfer Card</p>
    <br />
    ...
    <div v-if="!state.validAddress" class="ml-[2.1rem]">
      <br />
      ADDRESS IS INVALID
    </div>
    <div class="mt-3 ml-[2.1rem]">
      <BaseCCButton :type="Color.RED" @click="transfer()"> Transfer Card </BaseCCButton>
    </div>
  </div>
</template>
