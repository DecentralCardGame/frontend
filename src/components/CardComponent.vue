<template>
  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="550" v-bind:viewBox="viewBox" >
    ...
    <!-- Ressource cost -->
    <!-- Energy cost text -->
    <g v-show="model.cost.energy && !(model.type==='HQ')" id="g2312">
    ...
    <!-- Iron cost text -->
    <g v-show="model.cost.iron && !(model.type==='HQ')" id="g2312-6" transform="translate(25.7 -.6)">
    ...
    <!-- Lumber cost text -->
    <g v-show="model.cost.lumber && !(model.type==='HQ')" id="g2312-1" transform="translate(42.9 -.8)">
    ...
    <!-- Food cost text -->
    <g v-show="model.cost.food && !(model.type==='HQ')" id="g2312-0" transform="translate(58.8 -.7)">
    ...
    <!-- Mana cost text -->
    <g v-show="model.cost.mana && !(model.type==='HQ')" id="g2312-2" transform="translate(77.1 -.8)">
    ...
    <!-- Generic cost text -->
    <g v-show="model.cost.generic && !(model.type==='HQ')" id="g2312-4" transform="translate(93 -.7)">
  ...
  <!-- Tags -->
    <text v-for="(tag, index) in model.tag" v-bind:key="'tag'+index" id="text2527" :x="75 + index*46 - ((model.tag?model.tag.length:0) - 1)*23" y="237.4" fill="#FFDAA6" stroke-width=".1" font-family="Montserrat" font-size="4.6"  letter-spacing="1" text-anchor="start" xml:space="preserve">
    <tspan id="tspan2525" :x="75 + index*46 - ((model.tag?model.tag.length:0) - 1)*23" y="237.4" fill="#FFDAA6" fill-opacity="1" stroke-width=".1" font-family="Montserrat" font-size="4.6" font-style="medium" text-anchor="middle" writing-mode="lr-tb">{{ (tag || '').toUpperCase() }}</tspan>
  </text>
