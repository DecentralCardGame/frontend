...
<svg @mouseenter="cardmouseenter" @mouseleave="cardmouselave" @click="cardmouseclick" width="100%" height="100%" viewBox="0 0 154 240" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;">
    ...
    <g :opacity=opaque id="Icons-Spacing-Grey" serif:id="Icons Spacing Grey">
        ...
        <g :opacity=opaque transform="matrix(0.928122,0,0,0.780528,14.3377,2.27483)">
            ...
            <g v-show="!model.cost.energy" opacity="0.2" id="Ebene3">
        ...
        <g :opacity=opaque transform="matrix(0.900887,0,0,0.900887,109.698,4.15101)">
            ...
            <g v-show="!model.cost.food" opacity="0.2" id="Ebene_1-2-5">
                <g transform="matrix(1.06878,0,0,1.06878,-116.112,-4.60135)">
                    <g id="Ebene_2">
        ...
        <g v-show="!model.cost.iron" opacity="0.2" transform="matrix(0.601191,0,0,0.601191,29.7156,4.26699)">
            ...
            <g id="_-Eingebettetes-Dokument-" serif:id="(Eingebettetes Dokument)" transform="matrix(0.992943,0,0,0.989034,134.563,9.12312)">
                <g transform="matrix(1,0,0,1,-5.5,-5.5)">
                    ...
                    <g clip-path="url(#_clip1)">
                        ...
                        <g v-show="!model.cost.mana" opacity="0.2" id="Ebene_2">
                            <g id="Ebene_1-2">
            ...
            <g transform="matrix(1.02546,0,0,1.02546,94.5416,9.32348)">
                <g transform="matrix(1,0,0,1,-5.5,-5.5)">
                    <g id="Ebene_22" serif:id="Ebene_2">
                        ...
                        <g v-show="!model.cost.lumber" opacity="0.2" id="Ebene_1-2">
    ...
    <g :opacity=opaque >
      ...
      <!-- Attack -->
        <text v-show="model.type === 'Entity'" id="text2236-11" x="23" y="228.6" fill="#001433" fill-opacity="1" stroke="none" stroke-width=".2" font-family="Montserrat" font-size="9" font-stretch="normal" font-style="normal" font-variant="normal" font-weight="500" letter-spacing="0" style="line-height:1.25;-inkscape-font-specification:'Montserrat, Bold';font-variant-ligatures:normal;font-variant-caps:normal;font-variant-numeric:normal;font-feature-settings:normal;text-align:start" text-anchor="start" word-spacing="0" writing-mode="lr-tb" xml:space="preserve">
