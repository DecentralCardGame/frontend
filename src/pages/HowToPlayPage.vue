<template>
  <div class="article-temp width-temp">
    ...
    <div>
      <div>
        <!-- energy icon -->
        <img src="../assets/symbols/energy-class.png">
      </div>
      <div>
        <!-- food icon -->
        <img src="../assets/symbols/food-class.png" width="20px">
      </div>
      <div>
        <!-- iron icon -->
        <img src="../assets/symbols/iron-class.png" width="20px">
      </div>
      <div>
        <!-- mana icon -->
        <img src="../assets/symbols/mana-class.png" width="20px">
      </div>
      <div>
        <!-- lumber icon -->
        <img src="../assets/symbols/lumber-class.png" width="20px">
      </div>
    </div>
    <br>
