  ...
  .finally(() => {
    ...
    app.mixin({
      methods: {
        ...
        notifyFail: R.curry(function(title: string, text: string) {
          this.$notify({
        ...
        notifySuccess: R.curry(function(title: string, text: string) {
          this.$notify({
            group: "bottom-right-notification",
            title: title,
            text: text,
        ...
        notifyInfo: R.curry(function(title: string, text: string) {
          this.$notify({
            group: "bottom-right-notification",
            title: title,
            text: text,
